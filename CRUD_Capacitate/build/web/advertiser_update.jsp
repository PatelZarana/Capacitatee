...
<html>
    ...
    <body>
    <center><h1>Update Advertiser</h1></center>
    <center>
    <fieldset style="margin-bottom: 250px;margin-left: 500px;margin-right: 500px ">
        <legend>Update</legend>
        <form action="advertiser_update" method="post">
            
            <table>
                <tr>
                    <td align="center">Advertiser's id:</td>
                    <td align="center"><input type="text" name="adv_id"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
